...
using AntXaf.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using AntXaf.WebApi.Core;
using DevExpress.ExpressApp.AspNetCore.WebApi;
using AntXaf.WebApi.BusinessObjects;

namespace AntXaf.WebApi;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "AntXaf API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the AntXaf.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "AntXaf WebApi v1");
            });
        }
        else {
